...
var TaskService = (function () {
    ...
    TaskService.prototype.updateAllStatus = function (isDone) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this.http.post('/api/updateAllStatus/', { isDone: isDone }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    TaskService.prototype.getByName = function (title) {
